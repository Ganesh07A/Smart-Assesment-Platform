      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-2">
            Here are your assigned exams. Good luck!
          </p>
        </div>
              ...
              >
                ...
                {exam.isAttempted ? (
                  <button
                    ...
                    className="w-full py-3 bg-white border-2 border-gray-200 text-gray-600 font-bold rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-all flex justify-center gap-2 items-center"
                  >
                    📄 View Report
                  </button>
                ) : (
